...
int TMVAClassification_MC_CH6( TString myMethodList = "" )
{
  ...
  case 1:
    ...
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					    ...
					    "nTrain_Signal=701:nTrain_Background=7795:SplitMode=Random:NormMode=NumEvents:!V" );
    break;//(1042,12156)
  case 2:
  // CUT ESCLUSI PRIMARI
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
...
int main( int argc, char** argv )
{
  ...
  return TMVAClassification_MC_CH6(methodList);
}
