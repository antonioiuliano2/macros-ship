...
void prepareTMVAtree(){
  ...
  for (int ivtx=0;ivtx<nvertices;ivtx++){
    ...
    if(flag!=2 && flag!=5 && vz<-3000 && ntracks>=4 && vz>-36000){ // TOPOLOGIC CUT
...
int TMVAClassification_MC_CH2( TString myMethodList = "" )
{
  ...
  case 1:
    ...
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					    ...
					    "nTrain_Signal=1910:nTrain_Background=14566:SplitMode=Random:NormMode=NumEvents:!V" );
    break;//(1042,12156)
  case 2:
  // CUT ESCLUSI PRIMARI
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
...
int main( int argc, char** argv )
{
  ...
  return TMVAClassification_MC_CH2(methodList);
}
