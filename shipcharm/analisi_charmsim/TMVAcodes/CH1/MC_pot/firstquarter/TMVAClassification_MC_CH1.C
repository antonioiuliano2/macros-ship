...
int TMVAClassification_MC_CH1( TString myMethodList = "" )
{
  ...
  case 1:
    ...
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
					    ...
					    "nTrain_Signal=1695:nTrain_Background=2616:SplitMode=Random:NormMode=NumEvents:!V" );
    break;//(1042,12156)
  case 2:
  // CUT ESCLUSI PRIMARI
    dataloader->PrepareTrainingAndTestTree( mycuts, mycutb,
...
int main( int argc, char** argv )
{
  ...
  return TMVAClassification_MC_CH1(methodList);
}
