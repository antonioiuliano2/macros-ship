...
void TMVAClassificationApplication( TString myMethodList = "" )
{
  ...
  // reader->AddVariable( "var4",                &var4 );
   ...
   //
   TFile *input(0);
   TString fname = "./tmva_evaluation_vertices.root";
