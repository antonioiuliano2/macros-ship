...
void numu_analysis(){
    ...
    double ngeomok = 0, nvisible = 0, nspectro = 0, ndecayspectro = 0;
    ...
    //first time studying it, I want to check the angular deflection distributions
    TCanvas *cDecaySpectrocheck = new TCanvas();
    cDecaySpectrocheck->Divide(1,2);
    cDecaySpectrocheck->cd(1);
    effcut.hdeltaTX->Draw();
    cDecaySpectrocheck->cd(2);
    effcut.hdeltaTY->Draw();        
