...
for (int ineutrino = 0; ineutrino < 6; ineutrino++){ //loop on neutrino flavours
 ...
 else hsum[ineutrino] =  new TH1D(Form("20%i",-1 * neutrinos[ineutrino]),Form("Merge of histograms for neutrino %i",neutrinos[ineutrino]),400,0,400);
 ...
 if (neutrinos[ineutrino] > 0) h2D_sum[ineutrino] = new TH2D(Form("11_%i",neutrinos[ineutrino]), Form("log10pt vs log10p for neutrino %i", neutrinos[ineutrino]),100,-0.3,1.7,100,-2,1);
 else h2D_sum[ineutrino] = new TH2D(Form("21_%i",-1 *neutrinos[ineutrino]), Form("log10pt vs log10p for neutrino %i", neutrinos[ineutrino]),100,-0.3,1.7,100,-2,1);
