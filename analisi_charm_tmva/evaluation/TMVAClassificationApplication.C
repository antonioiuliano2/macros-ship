...
void TMVAClassificationApplication( TString myMethodList = "" )
{
  ...
  // reader->AddVariable( "var4",                &var4 );
   ...
   //
   TFile *input(0);
   TString fname = "./tmva_evaluation_MC_15_04_19.root";
   //TString fname = "./tmva_evaluation_MC_vertices.root";
 ...
 //  theTree->SetBranchAddress( "var4", &var4 );
   ...
   TFile *fout = new TFile("vtx_BDT_MC_15_04_19_evaluated.root","RECREATE");
